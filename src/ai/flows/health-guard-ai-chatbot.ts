...
const SymptomReportSchema = z.object({
  ...
  disease: z.string().optional().describe('The potential disease inferred from the symptoms (e.g., Influenza, Dengue, Norovirus, COVID-19).'),
...
2. Data Collection (Genkit + Firestore Integration): When users share symptoms or location, you MUST generate a structured 'symptomReport' object in your output. This object should include: 'location', 'reportedSymptoms', a 'disease' (inferred from the symptoms, e.g., "Influenza", "Dengue", "Norovirus"), a 'riskScore' (0-1 based on symptom severity, duration, and relevance to known outbreak patterns), and a brief 'aiSummary'. You must NOT reveal the internal scoring logic to the user.
